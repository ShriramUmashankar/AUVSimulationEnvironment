...
solution_matrix ,solution_time,sim_time=dynamics2.dynamics_solve()
# np.savetxt('solution_matrix_pid',solution_matrix)
# np.savetxt('solution_time_pid',solution_time)
x = solution_matrix[0,:]
y = solution_matrix[1,:]
z = solution_matrix[2,:]
