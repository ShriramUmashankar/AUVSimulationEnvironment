...
Kp=np.array([[150,0,0,0],[0,1000,0,0],[0,0,400,0],[0,0,0,200]])
Kd=np.array([[90,0,0,0],[0,400,0,0],[0,0,200,0],[0,0,0,100]])
Ki=np.array([[0.5,0,0,0],[0,0.6,0,0],[0,0,0.3,0],[0,0,0,1]]) 
...
def LQR(x, v, M, D, C):  # Lqr control
    ...
    e_state[4, 0] = -X1[4,0]
    e_state[5, 0] = np.arctan(m_lqr) - X1[5,0]
